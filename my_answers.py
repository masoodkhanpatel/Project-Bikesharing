...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = np.dot(self.weights_hidden_to_output, error) # Calculate the hidden layer's contribution to the error
        output_error_term = error # Backpropagated error terms 
